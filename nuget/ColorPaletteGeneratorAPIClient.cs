...
namespace APIVerve.API.ColorPaletteGenerator
{
    ...
    /// <summary>
    /// Client for the ColorPaletteGenerator API
    /// </summary>
    public class ColorPaletteGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/colorpalette";
        ...
        {
            { "color", new ValidationRule { Type = "string", Required = true, Format = "hexColor" } },
            { "scheme", new ValidationRule { Type = "string", Required = false } },
            { "variation", new ValidationRule { Type = "string", Required = false } },
            { "count", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 16 } },
            { "distance", new ValidationRule { Type = "number", Required = false, Min = 0, Max = 1 } },
            { "addComplement", new ValidationRule { Type = "boolean", Required = false } },
            { "webSafe", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public ColorPaletteGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorPaletteGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorPaletteGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ColorPaletteGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ColorPaletteGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ColorPaletteGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ColorPaletteGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ColorPaletteGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ColorPaletteGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ColorPaletteGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ColorPaletteGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ColorPaletteGeneratorQueryOptions options)
        {
