...
namespace APIVerve\Colorpalette;
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/colorpalette?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/colorpalette';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ColorpaletteClient] {$message}\n";
        }
    }
}
