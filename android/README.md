...
```gradle
dependencies {
    implementation 'com.github.apiverve:colorpalette-api:1.1.14'
}
```
...
```java
import com.apiverve.colorpalette.ColorPaletteGeneratorAPIClient;
import com.apiverve.colorpalette.APIResponse;
import com.apiverve.colorpalette.APIException;

// Initialize the client
ColorPaletteGeneratorAPIClient client = new ColorPaletteGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/colorpalette](https://docs.apiverve.com/ref/colorpalette)
...
- **Documentation:** [https://docs.apiverve.com/ref/colorpalette](https://docs.apiverve.com/ref/colorpalette)
- **Issues:** [GitHub Issues](https://github.com/apiverve/colorpalette-api/issues)
